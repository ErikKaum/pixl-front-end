    ...
    return (
        <div>
            <footer id="footer" className="relative z-50 dark:bg-gray-900">
                <div className=" border border-black dark:border-gray-700 py-16">
                        ...
                        <div className="lg:flex">
                            <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                                ...
                                <ul>
                                        <li>
                                            <Link href="#">
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Tell me more</a>
                                            </Link>
                                        </li>
                                </ul>
                                </div>
